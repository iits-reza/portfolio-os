...
function TopHeader() {
  return (
    <header className="w-[calc(100%_-_100px)] border-2 border-red-400 float-right p-[50px] pl-[100px] flex flex-row gap-[100px] align-middle content-center items-center justify-items-center">
