...
function TopHeader() {
  return (
    <header className="w-full h-screen border-2  float-right p-[50px] pl-[100px] flex flex-row gap-[100px] align-middle content-center items-center justify-items-center">
